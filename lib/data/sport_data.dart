...
const sportDetails = [
  SportModel(
    sportImage: 'assets/sportimages/CRICKET.png',
    sportTitle: 'Cricket',
    sportDesc:
  ...
  SportModel(
    sportImage: 'assets/sportimages/FIELDHOCKEY.png',
  ...
  SportModel(
    sportImage: 'assets/sportimages/FOOTBALL.png',
  ...
  SportModel(
    sportImage: 'assets/sportimages/BADMINTON.png',
  ...
  SportModel(
    sportImage: 'assets/sportimages/KABADDI.png',
    sportTitle: 'Kabaddi',
    sportDesc:
  ...
  SportModel(
    sportImage: 'assets/sportimages/WRESTLING.png',
  ...
  SportModel(
    sportImage: 'assets/sportimages/TENNIS.png',
    sportTitle: 'Tennis',
    sportDesc:
  ...
  SportModel(
    sportImage: 'assets/sportimages/ATHLETIC.png',
  ...
  SportModel(
    sportImage: 'assets/sportimages/BOXING.png',
    sportTitle: 'Boxing',
    sportDesc:
  ...
  SportModel(
    sportImage: 'assets/sportimages/SHOOTING.png',
    sportTitle: 'Shooting',
    sportDesc:
  ...
  SportModel(
    sportImage: 'assets/sportimages/CHESS.png',
    sportTitle: 'Chess',
    sportDesc:
  ...
  SportModel(
    sportImage: 'assets/sportimages/WEIGHTLIFTING.png',
  ...
  SportModel(
    sportImage: 'assets/sportimages/BASKETBALL.png',
    sportTitle: 'Basketball',
    sportDesc:
        'Basketball has gained a strong and growing presence in India, captivating fans and players alike with its fast-paced and dynamic gameplay. Played on a rectangular court with two teams aiming to score points by shooting a ball through the opponent\'s basket, basketball has seen increased popularity at both the grassroots and professional levels. The National Basketball Association (NBA) has played a crucial role in popularizing the sport, and initiatives like the Basketball Federation of India (BFI) have contributed to its development. Schools, colleges, and local communities actively participate in and promote basketball, fostering a vibrant basketball culture. With the emergence of talented players and the enthusiasm surrounding leagues like the Indian National Basketball Championship, the sport continues to make significant strides, making basketball an exciting and influential part of India\'s sports landscape.',
  ),
  SportModel(
    sportImage: 'assets/sportimages/GOLF.png',
    sportTitle: 'Golf',
    sportDesc:
  ...
  SportModel(
    sportImage: 'assets/sportimages/TABLETENNIS.png',
